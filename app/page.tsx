...
// --- 1. DATA OBJECT (The "Brain" of your dashboard) ---
const AGENT_DATA = {
  1: {
    title: "Initiation",
    ...
    <div className="bg-[#030712] text-zinc-100 font-sans selection:bg-blue-500/30 min-h-screen">
      ...
      <section id="experience" className="py-32 px-6 max-w-5xl mx-auto border-t border-white/5">
        ...
        <div className="space-y-24">
          <div className="group border-l border-white/10 pl-8 hover:border-blue-500 transition-colors">
            <p className="text-zinc-600 text-sm mb-4 font-mono uppercase tracking-widest">2022 — Present</p>
            <h4 className="text-3xl font-bold text-white tracking-tight italic mb-2">Senior Product Manager</h4>
            <p className="text-zinc-500 text-lg mb-8 uppercase text-xs font-bold tracking-widest">[Company Name]</p>
            <p className="text-zinc-400 leading-relaxed max-w-2xl font-light italic">
              Directed product strategy for core AI initiatives. Scaled user engagement by 40% through iterative data analysis and stakeholder alignment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="pm-agent-chain" className="py-32 border-y border-white/5 bg-[#040914]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Architecture Flow */}
          <div className="flex flex-wrap lg:flex-nowrap items-center justify-between gap-3 mb-16">
            {[1, 2, 3, 4, 5, 6].map((num) => (
              <div key={num} className="flex flex-1 items-center gap-2">
                ...
                >
                  ...
                  <p className="text-[9px] text-zinc-600 font-mono">{AGENT_DATA[num].evidence.split('•')[0]}</p>
                </button>
          ...
          >
            <div className="md:col-span-2">
              ...
              <p className="text-zinc-300 text-lg leading-relaxed mb-6 font-light italic">{AGENT_DATA[selectedAgent].role}</p>
          ...
          <div className="max-w-3xl mx-auto border border-white/10 rounded-[2rem] bg-black h-[500px] flex flex-col overflow-hidden shadow-2xl mb-32">
              ...
              <AnimatePresence>
                {messages.length === 0 && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8 py-6">
                    <p className="text-zinc-500 text-sm italic text-center uppercase tracking-widest">Ask about the stack or career roadmap.</p>
            ...
            <form onSubmit={handleSubmit} className="p-4 bg-zinc-950 border-t border-white/5 relative">
              ...
              <button type="submit" disabled={!input} className="absolute right-7 top-1/2 -translate-y-1/2 p-2 bg-white text-black rounded-lg"><Send size={16} /></button>
            </form>
          </div>
          ...
          <div className="mt-32 space-y-32 max-w-5xl mx-auto">
            <div>
              <div className="flex items-center justify-between mb-8 italic">
                <h4 className="text-2xl font-bold text-white tracking-tight">JSON Schema Preview</h4>
                <div className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">v1.3.0 • Traceability</div>
              </div>
  ...
  "verification_evidence": {
    "metrics": { "documents": 6, "covered": 100 }
      ...
      <section id="case-study" className="py-32 px-6 max-w-6xl mx-auto border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
           <div className="aspect-[4/5] bg-zinc-900 rounded-[2.5rem] border border-white/5 p-12 flex flex-col justify-end hover:border-white/20 transition-all group relative overflow-hidden italic cursor-pointer">
              <span className="text-blue-500 font-mono text-[10px] tracking-widest uppercase mb-4 font-bold">Fintech</span>
              <h4 className="text-4xl font-bold mb-4 leading-tight text-white italic">Optimizing Personal <br/>Finance Flows.</h4>
           </div>
           <div className="aspect-[4/5] bg-zinc-950 rounded-[2.5rem] border border-white/5 p-12 flex flex-col justify-end hover:border-white/20 transition-all group cursor-pointer italic">
              <span className="text-zinc-600 font-mono text-[10px] tracking-widest uppercase mb-4 font-bold">Internal Tools</span>
      ...
      <section id="contact" className="py-60 text-center">
        ...
        <a href="mailto:hello@example.com" className="text-2xl md:text-4xl text-zinc-500 hover:text-white transition-colors font-light tracking-tight border-b border-zinc-800 pb-2 italic">hello@example.com</a>
      </section>

      <footer className="py-20 text-center text-[10px] text-zinc-700 uppercase tracking-[0.5em] font-bold italic">© 2024 [YOUR NAME] • BUILT FOR PRODUCT LEADERS</footer>
